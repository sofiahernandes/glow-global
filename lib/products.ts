export const products = [
  {
    ...
    additionalImages: ["/phoneMinhasFinancas.png"],
  ...
  },
  {
    ...
    additionalImages: ["/phoneMeusEstudos.png"],
    formats: ["PDF", "Google Sheets"],
  ...
  },
  {
    ...
    price: 7.77,
    image: "/ipadPlannerDefinitivo.jpg",
    features: [
    ...
    description:
      "The Ultimate 2025 Personal Planner is designed to help you organize your life with style and efficiency. This comprehensive planner includes daily, weekly, and monthly views to keep you on track with all your goals and commitments. With dedicated sections for habit tracking, goal setting, and reflection, this planner is your all-in-one tool for a more productive and balanced life.",
    quote: "'The key is not to prioritize what's on your schedule, but to schedule your priorities.'✨ – Stephen Covey",
    additionalImages: ["/phonePlannerDefinitivo.png"],
    formats: ["PDF", "Printable Format"],
    url: "https://glowmerch.gumroad.com/l/ultimate-planner"
  },
]
